...
<body>
	<div ng-app="myapp">
		<div class="container" style="width: 829px; margin-bottom: 100px;">
							...
							<div ng-controller="myController">
								<security:authorize access="hasRole('ROLE_USER')">
									<a href="#" ng-click="addToCart(${product.id})"
										class="btn btn-info"
										style="margin-top: 0px; margin-left: 20px; width: 150px; float: left; margin-right: 20px;">
										<span class="glyphicon glyphicon-shopping-cart"></span>
									</a>
								</security:authorize>
								<a href="<c:url value="/getAllProducts" />" class="btn btn-info"
									style="margin-top: 0px; margin-left: 20px; width: 150px; float: right; margin-right: 20px;">
